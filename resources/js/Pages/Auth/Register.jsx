...
export default function Register() {
  ...
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen flex flex-col selection:bg-primary-fixed selection:text-on-primary-fixed">
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:wght@400;600;700;800&family=Montserrat:wght@400;500;600;700&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap"
        rel="stylesheet"
      />
      ...
      <header className="w-full top-0 sticky z-50 bg-surface border-b-2 border-outline-variant shadow-sm">
        <div className="flex justify-between items-center w-full px-4 md:px-10 py-3 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button className="material-symbols-outlined text-primary p-1 active:scale-95 transition-transform">
              language
            </button>
            <button className="material-symbols-outlined text-primary p-1 active:scale-95 transition-transform">
              settings
            ...
            <Link
              href={route("login")}
              className="bg-primary text-white px-6 py-2 rounded-full text-sm font-semibold active:scale-95 transition-all shadow-sm"
            >
              Acceder
            </Link>
          </div>
            ...
            <div className="hidden lg:flex flex-col justify-center items-center p-8 bg-surface-container text-center relative overflow-hidden">
              ...
              <div className="w-full max-w-sm mb-6 aspect-square rounded-full overflow-hidden border-8 border-surface-container-high shadow-xl transform rotate-1">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBhFj3m7tY-rvsHVKz_pdBiXPc8dblp2a9jpvIXYBHKZGMItSk630DC2aZNy-aHgQLYFf6PkOtSej6lYwEqGrBh3H3qTkAF6KjyZF3qj1Xf0PhPBJt3FUoL0AGRBe94WdukclDZlTmC6wJAa8HD__4HZ3SmXYnb0cc7BBidpn3a_MUb_iflkWQGYtMSrlzrxImKESqQRcNqGjD6DJplOX3CoDjgtVTlgUXP7b9hLhy6wsC0I5MnXP7E"
              ...
              <p
                className="text-lg text-on-surface-variant px-6"
                style={{ fontFamily: "Montserrat" }}
              >
                Únete a una comunidad dedicada a revitalizar nuestras lenguas
                ancestrales y celebrar la herencia mexicana.
              </p>
            ...
            <div className="p-6 lg:p-8 flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-sm text-on-surface-variant">
                  Regístrate para empezar tu aprendizaje cultural hoy.
                </p>
              </div>
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <label
                      className="text-sm font-semibold text-on-surface-variant block mb-1"
                      htmlFor="name"
                    >
                      Nombre Completo
                    </label>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      className="px-4 py-1 rounded-full border-2 border-secondary bg-secondary-container text-on-secondary-container text-sm font-semibold"
                      type="button"
                    >
                      Spanish
                    </button>
                    <button
                      className="px-4 py-1 rounded-full border-2 border-outline-variant hover:border-secondary transition-all text-sm font-semibold"
                      type="button"
                    >
                      Náhuatl
                    </button>
                  ...
                  <div className="space-y-1 transition-all duration-500">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-2 custom-scrollbar snap-x">
                      {[
                        {
                          id: "axolotl",
                          src: "https://lh3.googleusercontent.com/aida-public/AB6AXuAiPwXzbU32T2hkzwa0QvpjXl67NOwvIWP1VK78431YJSEQ28v7aqkLHgWW1HtjI9HhWBCVEocu4cA-eoSGEaAv5T0cogtc2pQxJEtXFHwZiiWuyw0XB6aWIWqf5k9QHUa2RQGXzxsqnU4HwMTHfELavOqKAvVIBvcDKVBAbmMLTqAjZgGgxDOFvEKrc91-Y4WELGKz8e3SlO4SBZNekqu5xSlOmcOS9ZXfpimd6cjenE0LVFb8rL8O",
                        },
                        {
                          id: "jaguar",
                          src: "https://lh3.googleusercontent.com/aida-public/AB6AXuDspi0KInOs50Xoi2uANObW8CVsODgbLAeORJQccmdwqa4h7zroChiWIs8FMjJo5JjuI9m2pkzFBzKibMgco-J7r1PvFTIC7hISLthucTdRASK6hgIJsHpkwQk27DbC1Tnvr6aMSeT8d8_j__bt8agc4WZGX1sc2EGJt2DITf5dFO2XZiiQMPIill-RykTa_Yhn5k2IOVhq-_TJPPU8CePDEkITGiH0lhmA2OWRnSiMO3JaehyYZw4-",
                        },
                        {
                          id: "colibri",
                          src: "https://lh3.googleusercontent.com/aida-public/AB6AXuCGG8Q3phxx35eg7JW61WNrzxcFJ5EGum1z-4se79xFl-33vJ9PLCaWBGVXEWjZTAf-Ps-PxFPm3fqWz8IjQIncxoSgwAoLmukyVp9x7OcxZupYua_gz6YZqR4MePXk5rcm29C3a-Qs-I15fBKsjl0sl-kk39X9uxefBw4DzCrgB7w14kNJXu7K07LQ9yM4pItmfteK3oe2Bo9Sz3eybk5f6XyV8jk9ZNymeIBTQW3-FAG0kDK-BkwZ",
                        },
                        {
                          id: "cactus",
                          src: "https://lh3.googleusercontent.com/aida-public/AB6AXuAempxvaP42avd6JfvK4BIEIpFg8iLlLm1DGdsSPiZWNg1PJ2xsiLnvAkqUWLpDxv8k3i0oKdRKNbsAnvK4YcTvLk3YDzB2zFSzBbApUVm-u7jHnlcKWx_qtIm9-87D5oveIzI3LeczCsd1fZrDJu6elQNIk-rnm5JwaIZS4gNgoetb7en3kJyfmJKYpfFo3yX1tNC9xV5JxGUvg7bteGlwi9qwmuEBylYpyW6Ukp37_cjdlcflJWbv",
                        },
                        {
                          id: "mariposa",
                          src: "https://lh3.googleusercontent.com/aida-public/AB6AXuC12CiEqPXFToyS9ffmkjw2x2isKnP7d1hRTNJHETJlFprdlMK0pgRn7Plvs9mJXBFU5Eo2gqLBffwC6RA0pSbpGG-B0FqMMOQezyP-I94C8Bc227v59dlo8KNAGB1BZIhtL2cgeNJsVkgLXEVZ1TwaZy1QEJbOuyEgW5A5lNi9J8BJ6haAfmU2FppvUGmmRs1eotCQyzoYeu2tOHfyFmNSxgDoW_y4BpE-HCAHP6BvIHaNIVJTCdP8",
                        },
                      ].map((avatarItem) => (
                        <div
                          key={avatarItem.id}
      ...
      <footer className="w-full mt-auto bg-surface-container-low border-t border-outline-variant">
        <div className="flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-10 py-6 max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              className="text-xs text-on-surface-variant hover:text-primary transition-all"
              href="#"
            >
              Privacidad
            </a>

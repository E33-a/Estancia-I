...
export default function LinguisticDataIndex({ 
    ...
    return (
        <>
            <Head title="Gestión de Datos Lingüísticos - Raíces Vivas" />

            {/* Estilos e íconos externos */}
            <link 
                href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,600;700;800&family=Montserrat:wght@400;500;600;700&display=swap" 
                rel="stylesheet" 
            />
            <link 
            ...
            <style>{`
                .radial-pattern {
                    opacity: 0.03;
                    background-image: radial-gradient(var(--tw-colors-primary, #9a4028) 1px, transparent 1px);
                    background-size: 24px 24px;
                }
                .sunset-shadow { box-shadow: 0 4px 14px -2px rgba(154, 64, 40, 0.08), 0 2px 4px -2px rgba(154, 64, 40, 0.04); }
                .btn-press-effect { border-bottom: 2px solid rgba(0,0,0,0.2); }
                .btn-press-effect:active { border-bottom-width: 0px; transform: translateY(2px); }
            `}</style>

            <div className="bg-background text-on-background font-body-md antialiased min-h-screen flex relative overflow-x-hidden">
                {/* Sidebar Dinámico */}
                <Sidebar 
                    isOpen={sidebarOpen} 
                ...
                {/* Main Content con ajuste dinámico de margen */}
                <div className={`${sidebarOpen ? 'ml-64' : 'ml-20'} flex-1 min-h-screen relative flex flex-col transition-all duration-300`}>
                    <AdminHeader user={auth?.user} />

                    <main className="flex-1 mt-16 p-lg md:p-margin-tablet overflow-y-auto overflow-x-hidden relative">
                        <div className="absolute inset-0 radial-pattern pointer-events-none"></div>
                        ...
                        <div className="max-w-7xl mx-auto relative z-10">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
                                ...
                                <div className="lg:col-span-2 flex flex-col gap-lg">
                                    ...
                                    {/* Dialectos Activos */}
                                    <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/40 sunset-shadow p-lg">
                                        <div className="flex justify-between items-center mb-md border-b border-outline-variant/30 pb-sm">
                                            ...
                                            <button className="bg-primary text-on-primary font-label-lg text-label-lg rounded-lg py-2 px-4 flex items-center gap-xs btn-press-effect hover:bg-primary/90 transition-colors">
                                    ...
                                    <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/40 sunset-shadow overflow-hidden flex flex-col">
                                            ...
                                            <div className="flex gap-sm">
                                                <form onSubmit={handleSearchSubmit} className="relative flex items-center w-64 h-10 rounded-lg bg-surface-container-lowest border-2 border-outline-variant focus-within:border-primary transition-colors px-2">
                                                    ...
                                                    <input 
                                                        ...
                                                        className="w-full outline-none text-body-md font-body-md bg-transparent"
                                                    />
                                                </form>
                                ...
                                <div className="lg:col-span-1 flex flex-col gap-lg">
                                    ...
                                    {/* Revisión de Audios */}
                                    <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/40 sunset-shadow flex flex-col max-h-[400px]">

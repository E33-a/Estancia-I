            ...
            <div className="font-body-md text-on-background min-h-screen flex flex-col bg-[#fdf7ff]">
                    ...
                    <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="hidden sm:block">
                                <h1 className="font-headline-md text-headline-md font-bold text-primary" style={{ fontFamily: 'Bricolage Grotesque' }}>Raíces Vivas</h1>
                        ...
                        <div className="flex items-center gap-2 md:gap-6">
                            ...
                            <div className="flex items-center bg-surface-container-high rounded-full px-3 py-1 border border-outline-variant">
                                <span className="material-symbols-outlined text-tertiary-container mr-1" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                                <span className="font-label-lg text-label-lg">{profile.stars}</span>
                            </div>

                            {/* Medallas dinámicas según conteo de la relación pivot */}
                            <div className="flex items-center bg-surface-container-high rounded-full px-3 py-1 border border-outline-variant">
                                <span className="material-symbols-outlined text-secondary mr-1" style={{ fontVariationSettings: "'FILL' 1" }}>workspace_premium</span>
                                <span className="font-label-lg text-label-lg">{badges.length}</span>
                            </div>
                            ...
                            <div className="hidden md:flex items-center bg-surface-container-low rounded-xl px-2 py-1 border border-outline-variant">
                                <span className="material-symbols-outlined text-primary mr-2">language</span>
                                <select 
                            ...
                            >
                                <span className="material-symbols-outlined md:mr-2">logout</span>
                ...
                <main className="flex-grow w-full max-w-7xl mx-auto px-4 py-8 md:py-12 relative">
                    ...
                    <div className="relative z-10 mb-12 text-center md:text-left">
                        <h2 className="font-display-lg text-display-lg text-on-surface mb-2" style={{ fontFamily: 'Bricolage Grotesque' }}>¿Qué aprenderemos hoy?</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative z-10 mb-16">
                        ...
                        {/* Cuentos */}
                        <div className="bg-surface-container-lowest rounded-3xl p-6 border-b-4 border-tertiary-container shadow-sm card-hover transition-all duration-300 cursor-pointer flex flex-col items-center text-center group">
                            <div className="w-24 h-24 mb-6 rounded-2xl bg-tertiary-fixed flex items-center justify-center floating">
                                <span className="material-symbols-outlined text-[48px] text-tertiary-container icon-animate" style={{ fontVariationSettings: "'FILL' 1" }}>auto_stories</span>
                            </div>
                            <h3 className="font-headline-md text-headline-md text-tertiary-container mb-2" style={{ fontFamily: 'Bricolage Grotesque' }}>Cuentos y Lecturas</h3>
                            <p className="font-body-md text-body-md text-on-surface-variant">Viaja por historias mágicas de México.</p>
                            <div className="mt-auto pt-6 w-full opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-tertiary-container text-white px-4 py-2 rounded-full font-label-lg">¡Leer ahora!</span>
                            </div>
                        </div>

                        {/* Juegos */}
                        <div className="bg-surface-container-lowest rounded-3xl p-6 border-b-4 border-secondary shadow-sm card-hover transition-all duration-300 cursor-pointer flex flex-col items-center text-center group">
                            <div className="w-24 h-24 mb-6 rounded-2xl bg-secondary-fixed flex items-center justify-center floating" style={{ animationDelay: '0.5s' }}>
                                <span className="material-symbols-outlined text-[48px] text-secondary icon-animate" style={{ fontVariationSettings: "'FILL' 1" }}>sports_esports</span>
                            </div>
                            <h3 className="font-headline-md text-headline-md text-secondary mb-2" style={{ fontFamily: 'Bricolage Grotesque' }}>Juegos Interactivos</h3>
                            <p className="font-body-md text-body-md text-on-surface-variant">Aprende palabras nuevas mientras juegas.</p>
                            <div className="mt-auto pt-6 w-full opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-secondary text-white px-4 py-2 rounded-full font-label-lg">¡A jugar!</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-surface-container-lowest rounded-3xl p-6 border-b-4 border-primary shadow-sm card-hover transition-all duration-300 cursor-pointer flex flex-col items-center text-center group">
                            <div className="w-24 h-24 mb-6 rounded-2xl bg-primary-fixed flex items-center justify-center floating" style={{ animationDelay: '1s' }}>
                                <span className="material-symbols-outlined text-[48px] text-primary icon-animate" style={{ fontVariationSettings: "'FILL' 1" }}>school</span>
                            </div>
                            <h3 className="font-headline-md text-headline-md text-primary mb-2" style={{ fontFamily: 'Bricolage Grotesque' }}>Lecciones</h3>
                            <p className="font-body-md text-body-md text-on-surface-variant">Sigue tu camino para ser un experto (Nivel {profile.level}).</p>
                            <div className="mt-auto pt-6 w-full opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-primary text-white px-4 py-2 rounded-full font-label-lg">Continuar</span>
                            </div>
                        </div>
                        ...
                        <div className="bg-surface-container-lowest rounded-3xl p-6 border-b-4 border-outline shadow-sm card-hover transition-all duration-300 cursor-pointer flex flex-col items-center text-center group">
                            <div className="w-24 h-24 mb-6 rounded-2xl bg-surface-container flex items-center justify-center floating" style={{ animationDelay: '1.5s' }}>
                                <span className="material-symbols-outlined text-[48px] text-outline icon-animate" style={{ fontVariationSettings: "'FILL' 1" }}>assignment</span>
                            </div>
                            <h3 className="font-headline-md text-headline-md text-outline mb-2" style={{ fontFamily: 'Bricolage Grotesque' }}>Mis Evaluaciones</h3>
                            <p className="font-body-md text-body-md text-on-surface-variant">¿Qué tanto has aprendido esta semana?</p>
                            <div className="mt-auto pt-6 w-full opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-outline text-white px-4 py-2 rounded-full font-label-lg">Ver retos</span>
                            </div>
                        </div>
                    ...
                    <div className="max-w-2xl mx-auto">
                        <button className="w-full bg-primary-container text-on-primary-container p-6 rounded-3xl flex items-center justify-between shadow-lg hover:shadow-xl transition-all press-effect group">
                            <div className="flex items-center text-left">
                                ...
                                <div>
                                    <h4 className="font-headline-md text-headline-md text-white" style={{ fontFamily: 'Bricolage Grotesque' }}>Mis Logros</h4>
                ...
                <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-surface border-t border-outline-variant flex justify-around items-center py-3 px-2 z-50 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
                    <Link href={route('dashboard')} className="flex flex-col items-center gap-1 text-primary">
                    ...
                    <a href="#" className="flex flex-col items-center gap-1 text-on-surface-variant">
                        ...
                        <span className="text-[10px] font-label-sm uppercase">Explorar</span>
                    </a>
                    <a href="#" className="flex flex-col items-center gap-1 text-on-surface-variant">
                        <span className="material-symbols-outlined">social_leaderboard</span>
                        <span className="text-[10px] font-label-sm uppercase">Podio</span>
                    </a>
                    <Link href={route('profile.edit')} className="flex flex-col items-center gap-1 text-on-surface-variant">
